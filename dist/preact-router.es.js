...
var PREACT_ROUTER_BASE = "preact-router-base";
...
var Router = (function (Component$$1) {
	...
	Router.prototype.getChildContext = function getChildContext () {
		var ret = {};
		ret[PREACT_ROUTER_BASE] = this.baseUrl;
		return ret;
	};
	...
	Router.prototype.getMatchingChildren = function getMatchingChildren (children, url, invoke) {
		...
		return children
			...
			.sort(pathRankSort)
			.map( function (vnode) {
				var path = this$1.baseUrl + vnode.attributes.path;
				var matches = exec(url, path, vnode.attributes);
				if (matches) {
					if (invoke !== false) {
...
export { PREACT_ROUTER_BASE, subscribers, getCurrentUrl, route, Router, Route, Link };export default Router;
